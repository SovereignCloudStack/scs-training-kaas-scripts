...
echo "Use kubectl config use-context $NEWCTX to switch to using new mgmt cluster"
echo "Use kubectl config use-context $OLDCTX to switch back to old mgmt cluster"
